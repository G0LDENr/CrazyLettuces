...
export const ConfigProvider = ({ children }) => {
    ...
    const texts = {
        es: {
            ...
            heroDescription: "Las lechugas más locas y deliciosas con chile, gomitas y mucho sabor. ¡Una experiencia única para tu paladar!",
            ...
            // --- Footer ---
            footerDescription: "Las lechugas más locas y deliciosas de la ciudad.",
            ...
            mision: "Misión",
            misionTexto: "Somos una empresa dedicada a la elaboración de Crazy Lettuces, Lechugas sembradas, tratadas y cosechadas para nuestro mercado de consumo, siendo este un producto natural, saludable y ecologico sin quimicos ni conservadores, asegurando el consumo saludable de nuestros clientes",
            vision: "Visión",
            visionTexto: "Ser una empresa de Lechugas preparadas para nuestra comunidad, ofreciendo sabor y frescura inigualables, satisfaciendo a nuestros clientes, con el fin de aumentar nuestras ventas en cada producto.",
            valores: "Valores",
            calidad: "Calidad",
            ...
            historiaTexto1: "nació de la idea de revolucionar el concepto de snacks saludables. Comenzamos con una simple pregunta: ¿por qué no combinar lo fresco de las lechugas con lo divertido de los toppings?",
